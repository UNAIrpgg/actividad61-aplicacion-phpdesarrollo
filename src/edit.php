...
$resultado = $mysqli->query("SELECT apellido, nombre, edad, fecha_ingreso, estado_recuperacion FROM beneficiarios WHERE id = $idempleado");
	...
	<form action="edit_action.php" method="post">
		...
		<div>
		 ...
		 <div>
                        ...
                        <input type="date" name="date" id="date" value="<?php echo $age;?>" required>
                </div>

		<div>
			<label for="job">Puesto</label>
			<select name="estado_recuperacion" id="job" placeholder="puesto">
				<option value="<?php echo $job;?>" selected><?php echo $job;?></option>
				<option value="No rehabilitado">Administrativo</option>
				<option value="En proceso de rehabilitacion">Contable</option>
				<option value="Rehabilitado">Dependiente</option>
			</select>
		</div>
