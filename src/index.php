...
A medida que avanza se va consturyendo cada fila de la tabla HTML con todos los campos del empleado, hasta completar todos los registros*/
	...
	while($fila = $resultado->fetch_array()) {
		...
		echo "<td>".$fila['fecha de ingreso']."</td>\n";
		echo "<td>".$fila['estado']."</td>\n";
		echo "<td>".$fila['acciones']."</td>\n";
		echo "<td>";
...
Este forma de pasar el dato se conoce como: método GET*/
		...
		echo "<a href=\"delete.php?idempleado=$fila[id]\" onClick=\"return confirm('¿Está segur@ que desea eliminar el registro/a?')\" >Baja</a></td>\n";
		echo "</td>";
		echo "</tr>\n";
	}//fin mientras
 }//fin si
